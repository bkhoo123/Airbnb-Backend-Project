  ...
  return (
    <div className="currentspots">
      ...
      : filter.map((spot, index) => (
        ...
        <h3>{spot.title} <button onClick={async (e) => await dispatch(thunkDeleteSpotFavorite(spot.favoriteId))} style={{background: 'None', borderStyle: 'none'}}><i style={{marginLeft: 5, fontSize: 20}} id="hearty" class="fa-solid fa-heart"></i></button> </h3>
